...
namespace ZooCalculationWebClient.Controllers
{
    public class ExcursionController : Controller
    {
        ...
        private readonly IRouteLogic courseLogic;
        ...
        {
            ViewBag.RouteForExcursions = courseLogic.Read(null);
            return View();
        }
        [HttpPost]
        ...
        private decimal CalculateSum(List<RouteForExcursionBindingModel> edRoutes)
        {
            ...
            {
                var courseData = courseLogic.Read(new RouteBindingModel { Id = course.RouteId }).FirstOrDefault();
