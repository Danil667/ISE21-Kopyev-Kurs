    ...
    public class SaveToWord
    {
        public static void CreateDoc(WordInfo info)
        {
            using (WordprocessingDocument wordDocument = WordprocessingDocument.Create(info.FileName, WordprocessingDocumentType.Document))
            {
                ...
                TableCell headerNameCell = new TableCell(new Paragraph(new Run(new Text("Название маршрута"))));
                TableCell headerStartRouteCell = new TableCell(new Paragraph(new Run(new Text("Дата начала маршрута"))));              
                ...
                headerRow.Append(headerStartRouteCell);               
                ...
                foreach (var route in info.Routes)
                {
                    ...
                    TableCell nameCell = new TableCell(new Paragraph(new Run(new Text(route.RouteName))));
                    TableCell StartRouteCell = new TableCell(new Paragraph(new Run(new Text(route.StartRoute.ToString()))));                    
                    TableCell costCell = new TableCell(new Paragraph(new Run(new Text(route.Cost.ToString()))));
                    routeRow.Append(numberCell);
                    routeRow.Append(nameCell);
                    routeRow.Append(StartRouteCell);
                    routeRow.Append(costCell);
                    table.Append(routeRow);
                    i++;
                }
